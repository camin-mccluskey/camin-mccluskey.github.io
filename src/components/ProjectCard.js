...
const ProjectCard = ({ project }) => {
  ...
  return (
    ...
    <div className="flex flex-col w-full md:min-h-full sm:min-h-full bg-gray-300 dark:bg-gray-900 rounded-lg px-5 py-3 
                    betterhover:hover:shadow-purple-lg dark:betterhover:hover:shadow-dark-lg
                    cursor-pointer 
                    transition-all ease-in-out duration-300 transform betterhover:hover:-translate-y-1 betterhover:hover:scale-105"
    >
      ...
      <div className="flex justify-evenly items-end space-x-12 space-y-3 flex-wrap dark:text-white">
        {badges.map((b, idx) => {
